...
function injectRender(script: string, render: string) {
  ...
  const componentKeyWord = getComponentKeyWord();

  script = script.replace(componentKeyWord, `${render}\n${componentKeyWord}\n`);
