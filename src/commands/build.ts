...
import { CSS_LANG } from '../common/css'; // 获取scss后缀
import { ora, consola, slimPath } from '../common/logger'; // 日志
import { installDependencies } from '../common/manager'; // 安装依赖
import { SRC_DIR, LIB_DIR, ES_DIR } from '../common/constant'; // 获取各个目录地址
